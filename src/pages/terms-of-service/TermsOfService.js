...
const TermsOfService = () => {
    return (
        <>
            ...
            <div className="px-4 py-10 md:py-16 bg-white text-gray-800 flex flex-col items-center text-base">
                <div className="w-full max-w-4xl">
                    ...
                    <div className="space-y-6 text-sm leading-relaxed">
                        ...
                        <blockquote className="border-l-4 border-gray-400 pl-4 italic text-sm text-gray-600">
                            By using our website, you (the visitor) agree to allow third parties to process your IP address,
                            in order to determine your location for the purpose of currency conversion. You also agree to have
                            that currency stored in a session cookie in your browser (a temporary cookie that gets automatically
                            removed when you close your browser). We do this in order for the selected currency to remain selected
                            and consistent when browsing our website so that the prices can convert to your (the visitor) local currency.
                        </blockquote>
                    ...
                    <div className='space-y-4 mt-6'>
                        <section>
                            <h2 className="text-lg md:text-xl font-semibold mb-2">Section 1 - Online Store Terms</h2>
                            <p className="mb-6 leading-relaxed">
                                ...
                                of residence, or that you are the age of majority in your state or province of residence and you have given us your consent
                        ...
                        <section>
                            <h2 className="text-lg md:text-xl font-semibold mb-2">SECTION 2 - GENERAL CONDITIONS</h2>
                            <p className="leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-lg md:text-xl font-semibold mb-2">SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</h2>
                            <p className="leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-lg md:text-xl font-semibold mb-2">SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</h2>
                            <p className="leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-lg md:text-xl font-semibold mb-2">SECTION 5 - PRODUCTS OR SERVICES (if applicable)</h2>
                            <p className="leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-lg md:text-xl font-semibold mb-2">SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</h2>
                            <p className="leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-lg md:text-xl font-semibold mb-2">SECTION 7 - OPTIONAL TOOLS</h2>
                            <p className="leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-lg md:text-xl font-semibold mb-2">SECTION 8 - THIRD-PARTY LINKS</h2>
                            <p className="leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-lg md:text-xl font-semibold mb-2">SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</h2>
                            <p className="leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-lg md:text-xl font-semibold mb-2">SECTION 10 - PERSONAL INFORMATION</h2>
                            <p className="leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-lg md:text-xl font-semibold mb-2">SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</h2>
                            <p className="leading-relaxed">
                                Occasionally there may be information on our site or in the Service that contains typographical errors, inaccuracies or omissions that may relate to product descriptions, pricing, guarantees, promotions, offers, product shipping charges, transit times and availability. We reserve the right to correct any errors, inaccuracies or omissions, and to change or update information or cancel orders if any information in the Service or on any related website is inaccurate at any time without prior notice (including after you have submitted your order).
                            </p>
                            <br />
                            <p className="leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-lg md:text-xl font-semibold mb-2">SECTION 12 - PROHIBITED USES</h2>
                            <p className="leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-lg md:text-xl font-semibold mb-2">SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</h2>
                            <p className="leading-relaxed">
                            ...
                            <br />
                            <p className="leading-relaxed">
                                You agree that from time to time we may remove the Products or Services for indefinite periods of time or cancel the Service at any time, without notice to you.
                            </p>
                            <br />
                            <p className="leading-relaxed">
                                You expressly agree that your use of, or inability to use, the Products or Services is at your sole risk. The Service and all products and Services delivered to you through the Service are (except as expressly stated by us) provided 'as is' and 'as available' for your use, without any representation, warranties or conditions of any kind, either express or implied, including all implied warranties or conditions of merchantability, merchantable quality, fitness for a particular purpose, durability, title, and non-infringement.
                            </p>
                            <br />
                            <p className="leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-lg md:text-xl font-semibold mb-2">SECTION 15 - SEVERABILITY</h2>
                            <p className="leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-lg md:text-xl font-semibold mb-2">SECTION 16 - TERMINATION</h2>
                            <p className="leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-lg md:text-xl font-semibold mb-2">SECTION 17 - ENTIRE AGREEMENT</h2>
                            <p className="leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-lg md:text-xl font-semibold mb-2">SECTION 18 - GOVERNING LAW</h2>
                            <p className="leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-lg md:text-xl font-semibold mb-2">SECTION 19 - CHANGES TO TERMS OF SERVICE</h2>
                            <p className="leading-relaxed">
