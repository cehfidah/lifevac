  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white px-4 py-12 flex flex-col items-center text-center">
        ...
        <p className="text-[#162950] max-w-xl">
          While we usually respond to all emails{" "}
          <strong>within 24 hours</strong>, please allow{" "}
          <strong>up to 2 working days</strong> to receive a reply!
        </p>
        <p className="py-4 text-2xl">-</p>
        <p className="text-[#162950]">
          If you are missing your order confirmation email,{" "}
          <strong>please check your spam email folder.</strong>
        </p>
        <p className="py-4 text-2xl">-</p>
        <p className="text-[#162950] mb-6">
          Please track your order using our <strong>tracking page</strong>.
        </p>
