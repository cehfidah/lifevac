    ...
    return (
        <>
            ...
            <div className="max-w-2xl mx-auto px-4 py-10 text-base text-gray-800 leading-relaxed">
                ...
                <p className='mb-6'>Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please  email us at info@airwayclear.us.</p>
