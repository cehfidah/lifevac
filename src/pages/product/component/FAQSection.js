        ...
        <div className="space-y-3 text-left">
          {faqs.map((faq, index) => (
            ...
            >
              ...
              >
                <span className="text-base md:text-xl">{faq.question}</span>
              ...
              {openIndex === index && (
                <div className="px-5 pb-4 text-base md:text-lg text-[#162950] border-t border-gray-200 leading-relaxed">
                  {isHTML(faq.answer) ? (
