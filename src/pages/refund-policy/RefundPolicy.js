    ...
    return (
        <>
            ...
            <div className="max-w-2xl mx-auto px-4 py-10 text-base text-gray-800 leading-relaxed">
                ...
                <p className="mb-6">
                    stating you would like to return your order. We will send you return instructions.
                </p>
                <p><br />If your return is accepted, we’ll send you instructions on how and where to send your package. Items sent back to us without first requesting a return will not be accepted. <br /><br />You can always contact us for any return question at info@airwayclear.us</p>
                ...
                <div title="info@versafind.shop" class="truncate">info@airwayclear.us</div>
            </div>
        </>
    )
}
